function single_warmstart(path_to_input, filename, verbose_ws, upper_bound, tugs, T, S, P_s, P_q, x, y, wqq, wqv, wvq, u)
    ...
    if verbose_ws == true
        print_single_warmstart(filename, upper_bound, tugs, T, S, x, y, wvq, wqv, wqq)
...
function print_single_warmstart(filename, upper_bound, tugs, T, S, x, y, wvq, wqv, wqq)
